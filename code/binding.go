...
func (b *Binding) Write(dst io.Writer) error {
	hdr := "// GENERATED BY GOFAIL. DO NOT EDIT.\n\n" +
		...
		"\t\"reflect\"\n" +
		")\n\n" +
		"type __fp_packageMarker struct{}\n" +
		"var __fp_packagePath = reflect.TypeOf(__fp_packageMarker{}).PkgPath()\n\n"
	...
	for _, fp := range b.fps {
		_, err := fmt.Fprintf(
			dst,
			"var %s *runtime.Failpoint = runtime.NewFailpoint(__fp_packagePath, %q)\n",
			fp.Runtime(),
			fp.Name())
		if err != nil {
			return err
